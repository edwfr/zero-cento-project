...
**Updated**: April 2026
**Status**: 152/165 sprint tasks completed (~92%), 13 remaining
**Source of truth**: [CHECKLIST.md](./CHECKLIST.md)

> Priority 0 below (Resend) is tracked separately from the sprint backlog — see [pre-deployment-review.md § B2](./pre-deployment-review.md).
...
- [x] **6.1** Add `prisma:migrate:prod` script to `package.json` ✅ _present in package.json_
...
- [x] **6.6** Complete Sentry integration — `src/instrumentation.ts` + `src/instrumentation-client.ts` creati, config server/edge aggiornati ✅ _20 Apr 2026_
